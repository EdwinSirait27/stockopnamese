        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                   ...
                   <div class="action-buttons d-flex align-items-center gap-5">
                        ...
                        <form action="{{ route('stockopname.refresh') }}" method="POST"
                            onsubmit="return confirm('Apakah Anda yakin ingin refresh data mstock_soglo?')">
                            @csrf
        ...
        $(function() {
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'kettoko',  name: 'kettoko',  className: 'text-center', defaultContent: 'empty' },
                    { data: 'masuk',    name: 'masuk',    className: 'text-center', defaultContent: 'empty' },
                    { data: 'personil', name: 'personil', className: 'text-center', defaultContent: 'empty' },
                    { data: 'inpmasuk', name: 'inpmasuk', className: 'text-center', defaultContent: 'empty' },
