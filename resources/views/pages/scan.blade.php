            ...
            $('#scanForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        // Tampilkan preview dan reset warning dulu
                        $('#preview-barcode').text(scannedItem.barcode);
                        $('#preview-name').text(scannedItem.name);
                    ...
                    error: function(xhr) {
                        if(xhr.status === 409) {
                            ...
                            // Tampilkan preview item dengan warning
                            $('#preview-barcode').text(scannedItem.barcode);
                            $('#preview-name').text(scannedItem.name);
                            $('#preview-warning').text('⚠ Item sudah pernah masuk sebelumnya!');
                            $('#preview-qty').val(1);
                            $('#preview-container').show();
...
$('#editForm').on('submit', function(e) {
    ...
    //         $('#posopnameTable').DataTable().ajax.reload();
    //     },
    //     error: function(xhr) {
